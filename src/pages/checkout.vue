<template>
	<MainLayout>
		<div id="CheckoutPage" class="mx-auto mt-4 max-w-[1200px] px-2">
				...
				<div class="md:w-[35%]">
					<div id="PlaceOrder" class="rounded-lg bg-white p-4">
						...
						<form @submit.prevent="pay()">
							<div id="card-element" class="rounded-sm border border-gray-500 p-2" />

							<p id="card-error" role="alert" class="text-center font-semibold text-red-700" />

							<button
								:disabled="isProcessing"
								type="submit"
								class="mt-4 w-full rounded-full bg-gradient-to-r from-[#FE630C] to-[#FF3200] p-1.5 text-[21px] font-semibold text-white"
					...
					<div class="mt-4 rounded-lg bg-white p-4">
						<div class="mb-2 mt-2 text-lg font-semibold">AliExpress</div>
