<template>
	<div id="FooterMain" class="mb-2 mt-10 w-full bg-[#E8E8E8]">
		<div class="mx-auto max-w-[1200px] px-4">
			<div class="w-full justify-between gap-4 md:flex">
				<div class="pt-4 md:w-[50%]">
				...
				<div class="pt-4 md:w-[50%]">
					...
					<div class="text-sm text-[#999999]">
						Russian, Portuguese, Spanish, French, German, Italian, Dutch, Turkish, Japanese, Korean, Thai, Vietnamese,
			...
			<div class="w-full justify-between gap-4 md:flex">
				<div class="pt-4 md:w-[50%]">
					...
					<div class="text-sm text-[#999999]">
						All Popular, Product, Promotion, Low Price, Great Value, Reviews, Blog, Seller Portal, BLACK FRIDAY,
	...
	<div id="FooterSub" class="w-full bg-[#333333] text-sm text-gray-400">
		<div class="mx-auto max-w-[1200px] p-4">
			...
			Transaction Services Agreement for non-EU/UK Consumers - Terms and Conditions for EU/EEA/UK Consumers
			(Transactions) - User Information Legal Enquiry Guide ©️2010-2022 AliExpress.com. All rights reserved.
